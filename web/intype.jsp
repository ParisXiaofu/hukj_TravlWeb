...
<ul>
<li>当月景点推荐</li>
<li><a href="/LineShowInfoServlet?lineID=${lineList1[4].lineID}">${lineList1[4].lineName}</a>  <a href="/LineShowInfoServlet?lineID=${lineList1[3].lineID}">| ${lineList1[3].lineName}</a></li>
<li>景点</li>
<li><a href="#">${lineList1[0].lineName}</a>  <a href="#">| ${lineList1[1].lineName}</a></li>
    <li><a href="#">${lineList1[2].lineName}</a>  <a href="#">| ${lineList1[3].lineName}</a></li>
    <li><a href="#">${lineList1[4].lineName}</a>  <a href="#">| ${lineList1[5].lineName}</a></li>
    <li><a href="#">${lineList1[6].lineName}</a>  <a href="#">| ${lineList1[7].lineName}</a></li>
    <li><a href="#">${lineList1[8].lineName}</a>  <a href="#">| ${lineList1[9].lineName}</a></li>
</ul>
</div>
<div class="jindinf-right">
    <ul class="jnImgs">
        <c:forEach var="line" items="${sessionScope.lineList1}">
...
<div class="jdtj-inf">
<ul id="tuijian">
<c:forEach var="line" items="${sessionScope.InlineList}">
...
<div class="jdfy">
    <a href="/ShowLineServlet?action=Inall&InpageIndex=1">首页</a>
    <a href="/ShowLineServlet?action=Inall&InpageIndex=${InpageIndex-1}">上一页</a>
    ${InpageIndex}/${IntotalPage}
    <a href="/ShowLineServlet?action=Inall&InpageIndex=${InpageIndex+1}">下一页</a>
    <a href="/ShowLineServlet?action=Inall&InpageIndex=${IntotalPage}">尾页</a>
</div>
</div>
<!--主体内容第四部分结束-->
<!--底部-->
